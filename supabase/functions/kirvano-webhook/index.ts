      ...
      if (resendApiKey) {
        ...
        try {
          await resend.emails.send({
            ...
            to: [email],
            subject: 'Bem-vindo ao TikTokSync! Seus dados de acesso',
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                <h1 style="color: #333; text-align: center;">🎉 Bem-vindo ao TikTokSync!</h1>
                
                <p style="font-size: 16px; color: #555;">
                  Obrigado por assinar o plano <strong>${plan === 'vitalicio' ? 'Vitalício' : 'Mensal'}</strong>!
                </p>
                ...
                <div style="text-align: center; margin: 30px 0;">
                  <a href="${loginUrl}" 
                     style="background: #7c3aed; color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: bold;">
                    Acessar TikTokSync
                  </a>
                </div>
