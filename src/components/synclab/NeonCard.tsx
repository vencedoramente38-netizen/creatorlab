  ...
  return (
    <div
      ...
      className={cn(
        ...
        selected
          ? "border-[hsl(var(--neon-pink))] bg-[hsl(var(--neon-pink))]/10 shadow-[0_0_15px_hsl(var(--neon-pink)/0.3)]"
          : "border-white/10 bg-card hover:border-white/20 hover:bg-white/5",
        className
      )}
    >
      {selected && (
        <div className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-[hsl(var(--neon-pink))] text-white shadow-lg">
